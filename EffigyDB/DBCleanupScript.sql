	...
	insert into supported_ext values('.ts','');
	...
	insert into skip_root values(null,'D:\\server\\3_TB_DRIVE\\PICTURES MASTER BACKUP\\Zdjecia\\tomcat-ZDJECIA');
	...
	insert into media_type_ext values(Null,'V','.ts');
